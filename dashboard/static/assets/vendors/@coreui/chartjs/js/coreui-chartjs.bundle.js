...
(function (global, factory) {
	...
	(function (global, factory) {
		...
		*/
		 ...
		 * @private
		 */
		helpers_dashboard.easingEffects = effects;
		 ...
		 * @private
		 */
		helpers_dashboard.clear = exports$1.clear;
		 ...
		 * @private
		 */
		helpers_dashboard.drawRoundedRectangle = function (ctx) {
			ctx.beginPath();
		...
		var defaults = {
			...
			_set: function (scope, values) {
				return helpers_dashboard.merge(this[scope] || (this[scope] = {}), values);
			}
		};
		...
		var valueOrDefault = helpers_dashboard.valueOrDefault;
		...
		function toFontString(font) {
			if (!font || helpers_dashboard.isNullOrUndef(font.size) || helpers_dashboard.isNullOrUndef(font.family)) {
				return null;
			}
		...
		var helpers_options = {
			...
			toPadding: function (value) {
				...
				if (helpers_dashboard.isObject(value)) {
					t = +value.top || 0;
					r = +value.right || 0;
					b = +value.bottom || 0;
					l = +value.left || 0;
			...
			_parseFont: function (options) {
				...
				var font = {
					...
					lineHeight: helpers_dashboard.options.toLineHeight(valueOrDefault(options.lineHeight, globalDefaults.defaultLineHeight), size),
					size: size,
			...
			resolve: function (inputs, context, index, info) {
				...
				for (i = 0, ilen = inputs.length; i < ilen; ++i) {
					...
					if (index !== undefined && helpers_dashboard.isArray(value)) {
						value = value[index];
						cacheable = false;
					}
					if (value !== undefined) {
		 ...
		 * @private
		 */
		helpers_dashboard.log10 = exports$2.log10;
		...
		// by the controller in dashboard.controller.js (`controllers[meta.type]`).
			...
			*/
			...
			updateLayout: function () {
				...
				helpers$1.each(me.boxes, function (box) {
					// _configure is called twice, once in dashboard.scale.update and once here.
		...
		var Scale = core_element.extend({
			...
			*/
			...
			update: function (maxWidth, maxHeight, margins) {
				...
				// _configure is called twice, once here, once from dashboard.controller.updateLayout.
